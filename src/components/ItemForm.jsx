...
export default function ItemForm() {
    ...
    return (
        <form className="py-5 px-7 flex flex-col gap-y-5" action="http://127.0.0.1:8000/api/item/add" method="post" onSubmit={(e)=> e.preventDefault()}>
            ...
            <div className="flex flex-col gap-y-1">
                ...
                <textarea name="note" id="item-note" cols="30" rows="3" style={{resize : "none"}} className="rounded-md border border-2 border-gray-400 px-4 py-3" placeholder="Enter a note"></textarea>
            </div>
            <div className="flex flex-col gap-y-1">
